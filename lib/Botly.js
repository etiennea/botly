...
const debugRequest = debug('botly:request');
...
Botly.prototype.getUserProfile = function (options, callback) {
    debugRequest('getUserProfile', options);
    let userId = options;
    if (typeof options === 'object') {
        userId = options.id;
    }
...
Botly.prototype.removePersistentMenu = function (options, callback) {
    debugRequest('removePersistentMenu', options);
...
Botly.prototype.setProfile = function (options, callback) {
    debugRequest('setProfile', options);
    const PAGE_URL = `${FB_URL}${options.pageId}/messenger_profile`;
...
Botly.prototype.sendAction = function (options, callback) {
    debugRequest('sendAction', options);
    request.post(
        {
            url: FB_MESSENGER_URL,
            json: true,
